      ...
      "
        >
          <motion.a
            target={"_blank"}
            className="w-6 mr-3"
            href="https://twitter.com/rickvill7"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://github.com/RillVicosuh"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            target={"_blank"}
            className="w-6 mx-3"
            href="https://www.linkedin.com/in/ricardo-villacana24/"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
          ...
          <motion.a
            ...
            href="https://opensea.io/RicoVill"
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.9 }}
            aria-label="Checkout my opensea profile"
          >
            <OpenseaIcon />
          </motion.a>
