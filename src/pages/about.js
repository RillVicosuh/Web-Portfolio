          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            ...
            md:col-span-8">
              ...
              <p className="font-medium text-dark dark:text-light">
                Get so good that you can't be stopped. That's what Kobe meant and that's the message I embody in every aspect of my life: building projects, exercise, diet, etc.
                ...
                instead being able to put on a championship performance. That's where I believe the thrill and fulfillment subsist.
              </p>
              <p className="my-4 font-medium text-dark dark:text-light ">
                ...
                I always emphasize the importance of being around like-minded people. As the proverb goes, "If you want to move fast, go alone; if you want to move far, go together."
              </p>
              <p className="font-medium text-dark dark:text-light">
                Whether I&apos;m working on an A.I., Full Stack, Blockchain, or other cool
